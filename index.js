...
function writeToFile(fileName, answers) {
  ...
  // Conditional check takes users input from [choices] and adds polygon properties and shape color to SVG string
  let shapeChoice;
  ...
  // generate svg file, takes file name from promptUser(), the svg string, and a ternary operator which handles logging any errors, or a "Generated logo.svg" message to the console  
